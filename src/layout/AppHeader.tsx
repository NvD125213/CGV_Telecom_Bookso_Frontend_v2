...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky z-100 top-0 flex w-full bg-white border-gray-200 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        ...
        <div
          ...
          <div className="flex items-center gap-2 2xsm:gap-3">
            ...
            <button
              type="button"
              className="relative text-blue-600 border border-blue-600 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 bg-white dark:bg-transparent">
